...
public class Ex01 {
	public static void main(String[] args) {
		...
		// 받은 문자열과 현재 문자열과 같은면 true, 다르면 false(대소문자 구별)
		// 5.equalsIgnoreCase(String anotherString)
		// 받은 문자열과 현재 문자열과 같은면 true, 다르면 false(대소문자 구별없음)
		// ** 주의) 문자열이나 객체를 비교할때 '=='는 사용하면 내용이 같냐가 아닌 주소가 같냐
		...
		String msg5 = msg4.format("%s의 시작 년도는 %d년 이고 평균점수는 %.1f이다", msg4, s5, s6);
		System.out.println(msg5);

		System.out.println("========================getBytes");
		// 7.getBytes() : byte[]
		// 해달 문자열을 byte[]로 변경시킨다.
		// 보통 입/출력 스트림 할때 사용한다.(영문자 대소문자와 숫자만 가능)
		String msg6 = "java";
		...
		// 반대로 해당 byte배열을 문자열로 만들수 있다.(String 생성자 이용)
		...
		// 보통 입/출력 스트림 할때 사용한다.(전 세계 모든 문자 가능)
		...
		// 반대로 해당 char배열을 문자열로 만들수 있다.(String 생성자 이용)
		...
		// 시작 위치를 받아서 해당 문자열 끝까지 문자열 추출
		// subString(int beginIndex,int endIndex) : String
		// 시작 위치와 끝 위치를 받아서 해당 문자열 추출(끝위치는 포함안됨)
		...
		// 20. trim() : String
		// 해당 문자열의 앞,뒤 있는 공백 제거, 중간 공백은 제거 불가(중간공백은 문자취급 당한다.)
		...
		// 21.의 반대 개념 ( 각종 자료형 모양의 문자열을 각종 자료형으로 변경 )
		...
		// - 원래 의미는 기본 자료형을 객체로 만들 때 사용하는 클래스
		...
		msg = "true";
		/*
		 * boolean형이 아니라서 오류발생 if(msg) { break; }
		 */
		...
		// 4) Char형태의 문자열을 char형으로 변경할 메소드는 없다
		...
		// 앞자리 두 자이레 19나 20을 붙여라
		// (gender가 1또는 2이면 1, 3또는 4이면 20)
